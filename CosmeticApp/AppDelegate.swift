...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func createTabBar() -> UITabBarController {
        ...
        //MARK:CartVC
        let cartVC = CartVC()
        let cartNavigation = UINavigationController(rootViewController: cartVC)
        cartNavigation.title = "Cart"
        //MARRK:NotificationVC
        let notificationVC = NotificationVC()
        let notificationNavigation = UINavigationController(rootViewController: notificationVC)
        notificationNavigation.title = "Notification"
        
        //MARK:UserVC
        let userVC = UserVC()
        let userNavigation = UINavigationController(rootViewController: userVC)
        userNavigation.title = "User"
        
        tabbar.setViewControllers([homeNavigation,searchNavigation,cartNavigation,notificationNavigation,userNavigation], animated: true)
